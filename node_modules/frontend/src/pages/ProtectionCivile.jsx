...
.pc-figure figcaption{margin-top:.6rem;font-size:.63rem;font-weight:600;opacity:.75;}
...
.lead{font-size:.74rem;line-height:1.55;margin:0 0 1rem;font-weight:500;}
.bullet{margin:.25rem 0 0;padding-${dir==='rtl'?'right':'left'}:1.2rem;display:flex;flex-direction:column;gap:.5rem;font-size:.72rem;font-weight:600;}
...
@media (max-width:760px){.pc-section{padding:1.15rem 1.05rem 1.55rem;}.pc-intro{font-size:.75rem;} .bullet{font-size:.69rem;}}
