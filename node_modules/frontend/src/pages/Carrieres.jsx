...
.lead{margin:.2rem auto 1.1rem;font-size:.9rem;line-height:1.6;font-weight:500;color:#f0fdf4;max-width:900px;text-align:center;}
...
.car-section h2{margin:0 0 1.3rem;font-size:clamp(1.15rem,2.3vw,2rem);font-weight:800;letter-spacing:.05em;color:#065f46;text-transform:uppercase;text-align:center;}
.mini-title{margin:0 0 .8rem;font-size:clamp(.95rem,1.4vw,1.15rem);font-weight:700;color:#065f46;letter-spacing:.04em;}
.table-scroll{overflow:auto;}
.car-table{width:100%;border-collapse:collapse;font-size:.7rem;min-width:620px;}
...
.car-table tbody td{background:#fff;font-weight:600;}
...
.bullets{margin:0;padding-${dir==='rtl'?'right':'left'}:1.05rem;display:flex;flex-direction:column;gap:.55rem;font-size:.7rem;font-weight:600;color:#064e3b;}
/* Responsive table -> cards */
@media (max-width:760px){
  .car-section{padding:1.3rem 1.05rem 1.7rem;}
  /* Increased base table font-size for better legibility on small screens */
  .car-table{font-size:.7rem;min-width:0;}
  ...
  .bullets{font-size:.74rem;line-height:1.35;}
