...
export default function Investissements(){
  ...
  const ar = {
    ...
    rows:[
      ['1','تجزئة السكن الاجتماعي "واد الذهب"','122 قطعة سكنية، روضة أطفال، مركز تجاري، موقف سيارات، مساحة خضراء','السكن','جماعة الحاجب','جمعية واد الذهب'],
      ['2','مركب سوسيو تربوي وتجاري "ابتسامة"','مركز تجاري، قاعة متعددة الاستعمالات، مركز استقبال، مكاتب، مطعم بالطابق الأرضي','تجارة واجتماعي','جماعة الحاجب','المجلس الإقليمي للحاجب'],
      ['3','تسوية وتوسعة التعاونية اللبنية "إنواسَر"','تجهيزات للبناء، تهيئة وتسوية','الصناعات الغذائية','جماعة عين تاوجدات','تعاونية إنواسَر'],
      ['4','توسعة المركب الصناعي الفلاحي','بناء مخازن للحبوب وصوامع للتخزين','الصناعات الغذائية','جماعة عين تاوجدات','شركة معاصر زيوت سوس'],
      ['5','السوق المغطى "سويكة"','38 دكاناً، قنوات لتصريف مياه الأمطار','تجارة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['6','بناء وتهيئة سوق أسبوعي','ساحة للحبوب، سوق للماشية، محلات للجزارة والأسماك، مقهى ومطعم، مرافق صحية، إدارة، سكن للحارس...','تجارة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['7','تجزئة السكن "فردوس"','160 قطعة إعادة إسكان، 62 قطعة اقتصادية، 3 قطع تجهيزات','السكن','جماعة الحاجب','شركة العمران'],
      ['8','تجزئة السكن "الياقوت 1"','414 قطعة اقتصادية، 3 قطع تجهيزات','السكن','جماعة الحاجب','شركة العمران'],
      ['9','تجزئة السكن "الياقوت 2"','538 قطعة اقتصادية، 7 قطع تجهيزات','السكن','جماعة الحاجب','شركة العمران'],
      ['10','تجزئة "أم ريب"','213 قطعة اقتصادية، 3 قطع تجهيزات','السكن','جماعة الحاجب','جمعية الخير'],
      ['11','تجزئة "الخضراء"','404 قطعة اقتصادية، 4 قطع تجهيزات','السكن','جماعة الحاجب','محمد العايت وشركاؤه'],
      ['12','تجزئة "مليكة"','138 قطعة اقتصادية، 4 قطع تجهيزات','السكن','جماعة الحاجب','زكريا اليعشوي'],
      ['13','تجزئة "أوبي"','49 قطعة اقتصادية، 5 قطع عمارات، 3 قطع تجهيزات','السكن','جماعة الحاجب','شركة أموقة'],
      ['14','تجزئة "شيبة 2"','32 قطعة اقتصادية','السكن','جماعة الحاجب','شركة دلسام'],
      ['15','أسواق عَسِيمَا','قاعة بيع 700م²، محطة خدمات ومعرض','تجارة','جماعة الحاجب','عسِيمَا'],
      ['16','مركب ديني وثقافي','استقبال عام، ندوات، مؤتمرات، إدارة، مركب ديني، مركز توثيق وغيرها','خدمات متنوعة','جماعة الحاجب','وزارة الأوقاف والشؤون الإسلامية'],
      ['17','فضاء الحرفي','مبنى من طابقين: الطابق الأرضي 6 ورشات، قاعة عرض، مقهى، حضانة، فضاء بيع، مرافق صحية، موقف سيارات؛ الطابق العلوي 4 ورشات، قاعة عرض، قاعة تكوين، مكتب، قاعة استقبال، قاعة اجتماعات، قاعة صلاة، مستودع، مرافق صحية','حرف يدوية','جماعة الحاجب','المجلس الإقليمي'],
      ['18','مصحة متعددة التخصصات','مصحة، مطبخ، قاعة طعام، مقصف، مختبر، صيدلية، مدرسة ممرضين، مركز إعادة تأهيل، قسم الأشعة، حراسة، مساحة خضراء، طرق، مواقف سيارات وسور','خدمات متنوعة','جماعة الحاجب','حدو أولاسيت'],
      ['19','عملية اجتماعية "جواهر"','2500 سكن اجتماعي','السكن','جماعة عين تاوجدات','أحمد العيوج'],
      ['20','تجزئة "رياض السلام"','116 قطعة عمارات، 156 قطعة سكن اقتصادي، 78 قطعة فيلات، 6 قطع تجهيزات و14 محل تجاري','السكن','جماعة عين تاوجدات','العربي حرافي'],
      ['21','تجزئة "سلام 2"','150 قطعة سكن اقتصادي و4 قطع تجهيزات','السكن','جماعة عين تاوجدات','شركة العمران'],
      ['22','تجزئة "أكدال"','245 قطعة سكن اقتصادي و4 قطع تجهيزات','السكن','جماعة عين تاوجدات','عبد الواحد مسعودي'],
      ['23','تجزئة "السعدية"','60 قطعة سكن اقتصادي و2 تجهيزات','السكن','جماعة عين تاوجدات','عبد الأحد برادة'],
      ['24','تجزئة "شمس"','60 قطعة سكن اقتصادي و3 تجهيزات','السكن','جماعة عين تاوجدات','شركة المبسوط'],
      ['25','تجزئة "أميرة"','34 قطعة سكن اقتصادي','السكن','جماعة عين تاوجدات','أحمد بوعنوزان'],
      ['26','محطة معالجة المياه','محطة معالجة، 3 أحواض لاهوائية','البناء والأشغال العمومية','جماعة القصير','جماعة عين تاوجدات'],
      ['27','مركب ترفيهي وسياحي','موتيل، 4 بنغالو وملحقاتها','سياحة','جماعة آيت نعمان','شركة منتزه آيت نعمان'],
      ['28','مركز رياضي وترفيهي وسكني','تجهيزات مشتركة: ملعب رياضي، مسبح، مقهى، مركز تجاري، موتيل، مسجد، شاليهات فردية ومزدوجة، مجموعات سكنية، مساحات خضراء، طرق، مواقف سيارات وسياج','سياحة وترفيه وخدمات','جماعة آيت نعمان','حدو أولاسي'],
      ['29','بناء سوق أسبوعي جديد بجماعة عين تاوجدات','محلات تجارية وملحقاتها','تجارة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['30','توسعة قصر روسلان / إنشاء قبو / مجمع سياحي بيئي','توسعة القصر (سعة 110.000 هكتوليتر)، وحدة تعبئة (30.000 زجاجة/ساعة)، مجمع سياحي بيئي عالي المستوى','صناعة غذائية وسياحة','جماعة إقادار','شركة أقبية مكناس'],
      ['31','بناء نادي فندقي','استقبال، مركز توعية وتكوين، حديقة حيوانات، مركز رياضي، بستان تعليمي، مطعم، مقصف، مكتبات، متجر منتجات عضوية، حديقة خضروات تعليمية، حديقة نباتية، 20 بنغالو، مسجد، مقصف، غرف تبديل ملابس، مسابح، أكشاك، مواقف سيارات، منطقة فرز النفايات، حوض معالجة المياه العادمة ومسارات للمشاة','صناعات غذائية وسياحة','جماعة إقادار','شركة أطلس ولاكي'],
      ['32','محطة تربية الخيول','استقبال، مكاتب، مختبر، صناديق، مرافق صحية، ساحة استرخاء، ساحة تزاوج، منطقة غسيل، رصيف تفريغ وسور','زراعة','جماعة إقادار','سوريك'],
      ['33','بناء مركز للاتصال','مركز اتصال','خدمات متنوعة','جماعة الحاجب','أبو إلهام'],
      ['34','إنجاز سوق أسبوعي بمدينة الحاجب','محلات تجارية، ساحة للحبوب، أسواق للأغنام والماعز، سوق للأبقار، محلات جزارة وأسماك، مرافق صحية، إدارة، سكن للحارس، سياج، مقهى ومطعم','تجارة وخدمات','جماعة الحاجب','جماعة الحاجب'],
      ['35','إنجاز مركز ترفيهي ومنطقة استراحة','مقهيان-مطعمان، مسبح، 6 بنغالو خشبي، حديقة ألعاب للأطفال وملحقاتها','سياحة وخدمات','جماعة آيت بورزوين','شركة منطقة استراحة أطلس بلادي'],
      ['36','سوق أسبوعي بمدينة سبع عيون','محلات تجارية، منصة للبيع بالجملة وملحقاتها','تجارة','جماعة سبع عيون','مجلس جماعة سبع عيون'],
      ['37','إنجاز ملعب رياضي وملحقاته','ملعب رياضي، مجمع تجاري يضم 75 محلاً، محل أسماك وملحق','خدمات متنوعة','جماعة الحاجب','جماعة الحاجب'],
      ['38','بناء مشروع سكني "الأمل"','84 قطعة سكنية','السكن','جماعة الحاجب','جمعية الأمل لموظفي المديرية الإقليمية للفلاحة بالحاجب'],
      ['39','تهيئة المساحة الخضراء المحاذية للطريق الحديدي وساحة 20 غشت ودار الشباب','تهيئة المساحات الخضراء، تغطية الأرضيات، تجهيز الحوض والري، الإنارة ...','خدمات متنوعة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['40','بناء قاعة رياضية متعددة الاستعمالات وقاعة اجتماعات','قاعة مغطاة بملحقاتها، ملاعب في الهواء الطلق وملحقاتها','خدمات متنوعة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['41','بناء مكتبة','مكتبة ...','خدمات متنوعة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['42','إنجاز تجزئة "لسعدام"','تجزئة سكنية','السكن','جماعة إقادار','جماعة إقادار'],
      ['43','مدرسة خاصة','مؤسسة تضم 35 قاعة دراسية، قاعتين للمعلوميات وملحقات','تعليم','جماعة الحاجب','شركة فريهاب / الأمانة'],
      ['44','برنامج عقاري "الكرامة"','96 سكن اجتماعي، 21 قطعة فيلات','السكن','جماعة الحاجب، إقليم الحاجب','شركة العمران مكناس'],
      ['45','مشروع غراسة الأشجار المثمرة','مختبر زراعة الأنسجة، غرفة تبريد، ساحة توزيع الأخشاب بعلامة تجارية','الصناعات الغذائية','جماعة سبع عيون','أحمد إسماعيلي'],
      ['46','عملية "الرحمة"','76 قطعة سكن اقتصادي و20 قطعة عمارات','السكن','جماعة سبع عيون','جماعة سبع عيون'],
      ['47','عملية "ديفيكو"','586 قطعة سكن اقتصادي، 945 قطعة فيلات، 26 قطعة عمارات و131 قطعة صناعية','السكن','جماعة سبع عيون','شركة ديفيكو'],
      ['48','سوق أسبوعي','محلات تجارية (بوتيكات)','تجارة','جماعة أكوراي','جماعة أكوراي'],
      ['49','تجزئة "منصوري"','35 قطعة سكن اقتصادي وقطعة تجهيزات واحدة','السكن','جماعة أكوراي','شركة دماسي لكساس'],
      ['50','تسوية الوضعية العقارية للأرض التي تحتضن السوق ...','88 محلاً، مسجد، ثلاجة، مستودع، ميزان، مركز شرطة، مرافق صحية ...','تجارة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['51','تسوية عقارية للأرض التي تحتضن السوق النموذجي','451 محلاً، 32 محلاً للخضر، وملحق للبائعين المتجولين','تجارة','جماعة عين تاوجدات','جماعة عين تاوجدات'],
      ['52','تجزئة "النخيل"','4 مراحل تضم: 1183 قطعة اقتصادية، 504 سكن اجتماعي و8 قطع تجهيزات','السكن','جماعة القصير','شركة ديفيكو / إسكانس'],
      ['53','إعادة إسكان وهيكلة وتجهيز دوار واد نيا','إعادة إسكان، هيكلة وتجهيز الدوار','البناء والأشغال العمومية','جماعة القصير','جماعة القصير'],
      ['54','تجزئة "الوفاق"','17 قطعة سكن اقتصادي','السكن','جماعة آيت بوبيدمان','جمعية الوفاق'],
      ['55','تهيئة وبناء مزرعة فطر','سكن رئيسي، استقبال، مطعم، إدارة، إقامة ريفية، غرف زراعة مجهزة، وحدات تعبئة وتغليف ووحدة كمبوست','الصناعات الغذائية','جماعة راس اجيري','شركة نكهات الشرق والمغرب'],
      ['56','تجزئة "النجاة"','46 قطعة سكن اقتصادي','السكن','جماعة راس اجيري','جمعية النجاة'],
    ],
  };
