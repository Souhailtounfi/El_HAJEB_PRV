...
.lead{font-size:.95rem;line-height:1.6;margin:0 0 1.05rem;font-weight:500;}
.bullet{margin:.35rem 0 1.7rem;padding-${dir==='rtl'?'right':'left'}:1.2rem;display:flex;flex-direction:column;gap:.6rem;font-size:.9rem;}
...
.sub-head{margin:1.55rem 0 1.05rem;font-size:1rem;font-weight:800;color:#065f46;letter-spacing:.05em;text-decoration:underline;text-decoration-thickness:2px;text-underline-offset:4px;}
...
.table-head{background:linear-gradient(135deg,#0e7490,#047857);color:#fff;font-weight:700;letter-spacing:.05em;text-align:center;padding:.8rem 1rem;font-size:.85rem;}
.table-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));font-size:.8rem;font-weight:600;}
...
.media figcaption{margin-top:.65rem;font-size:.8rem;font-weight:600;opacity:.9;}
.mt{margin-top:2rem;}
@media (max-width:720px){.ee-section{padding:1.25rem 1.05rem 1.7rem;}.bullet{font-size:.85rem;} .table-grid{font-size:.74rem;} .lead{font-size:1rem;} .table-head{font-size:.9rem;} }
`}</style>;}
